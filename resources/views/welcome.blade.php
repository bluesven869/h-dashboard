...
<head>
    ...
    <!-- Page title -->
    <title>{{ config('app.name', 'Homer Admin') }}</title>

    <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
    <!--<link rel="shortcut icon" type="image/ico" href="favicon.ico" />-->

    <link href="{{ asset('css/fontawesome/css/font-awesome.css') }}" rel="stylesheet" />
    <link href="{{ asset('js/metisMenu/dist/metisMenu.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('css/pe-icon-7-stroke/css/helper.css') }}" rel="stylesheet" />
...
<script src="{{ asset('js/sparkline/index.js') }}"></script>
